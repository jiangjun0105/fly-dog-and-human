...
**Phase 1 — Synaptic learning in stable environment:**
...
- Unconstrained w_ij (can cross zero, initialized with confidence
  weighting — high-confidence signs start far from zero, "unclear"
  neurons start near zero)

**Phase 2 — Adaptation to changing environments:**
